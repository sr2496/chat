<template>
  <Sheet :open="isOpen" @update:open="(v: boolean) => { if (!v) handleCloseGroupModal() }">
    <SheetContent side="left" class="max-w-sm flex flex-col">
              ...
              <div class="flex items-center justify-between text-white">
                <div class="flex items-center gap-3">
                  ...
                  <div class="flex flex-col">
                    <SheetTitle class="text-xl font-bold text-white">Add Participants</SheetTitle>
...
export default defineComponent({
  components: { UserAvatar, EmojiPicker, Sheet, SheetContent, SheetTitle },
  props: {
  ...
  setup(props, { emit }) {
    ...
    const toggleGroupUser = (user: { id: number; name: string }) => {
