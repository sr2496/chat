<!-- ChatHeader.vue -->
<template>
  <div class="bg-chat-surface shadow-sm px-4 py-4 flex items-center justify-between border-b border-chat-border">
    <div class="flex items-center gap-3">
      <!-- Avatar -->
      <UserAvatar
        :avatar="activeConversation?.display_avatar"
        :name="activeConversation?.name || 'Unknown'"
        size="md"
        :is-online="isOnline"
        :show-online="activeConversation?.type === 'private'"
      />
    ...
    <div class="flex items-center gap-2">
      <button class="p-2.5 rounded-full hover:bg-chat-bg/50 transition">
