...
<template>
  <div
    ...
    :data-day="getMessageDay(message.created_at)"
    class="flex mb-6 message-row group relative"
  ...
  >
    ...
    <UserAvatar
      ...
      size="sm"
      :is-online="message.sender?.online"
      :show-online="false"
    />
    ...
    <div class="max-w-[75%]">
      <div class="relative">
        <div
          class="relative px-4 py-2 rounded-2xl shadow-sm overflow-hidden"
          :class="bubbleClasses"
        >
          <!-- Tail -->
          <svg
            class="absolute bottom-0 w-4 h-4"
            :class="tailClasses"
            fill="currentColor"
            viewBox="0 0 16 16"
          >
          ...
          <div
            v-if="isUploading"
            class="absolute inset-0 bg-black/30 flex items-center justify-center rounded-2xl"
          >
          ...
          <!-- File Preview -->
          <!-- File Preview with Dynamic Icon -->
          <div
          ...
          >
            ...
            <div class="flex-shrink-0">
              ...
              <!-- ZIP / Archive -->
              <svg
                v-else-if="/zip|rar|7z/.test(fileExt)"
        ...
        >
          <span
            ...
            :key="emoji"
            class="px-2 py-1 text-xs bg-white dark:bg-gray-800 rounded-full shadow border"
          >
