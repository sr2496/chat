<template>
  <div class="flex h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 overflow-hidden">
    ...
    <div class="hidden sm:flex w-full sm:w-96 lg:w-[420px] border-r border-gray-200 dark:border-gray-800 flex-col bg-white dark:bg-gray-900">
      <ChatList />
    </div>
    ...
    <div class="flex-1 flex flex-col h-full relative">
      ...
      <div v-if="!isMobile" class="flex flex-col h-full">
        ...
        >
          <div class="text-center max-w-md px-8">
            ...
            <p class="text-lg text-gray-500 dark:text-gray-400">Select a conversation from the list to start chatting</p>
          </div>
        </div>
      ...
      >
        ...
        >
          ...
          <div class="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-4 py-3 flex items-center gap-4">
            <button
              @click="chatStore.activeConversationId = null"
            ...
            <div class="flex items-center gap-3">
              <img
                :src="activeConversation?.display_avatar || 'https://randomuser.me/api/portraits/women/68.jpg'"
