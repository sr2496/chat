<template>
    <div class="px-4 pb-4 pt-2 w-full max-w-5xl mx-auto z-20">
                ...
                <div class="flex items-center justify-between p-3 pl-4">
                    <div class="flex-1 min-w-0 mr-4">
                        <div class="flex items-center gap-2 mb-0.5">
                            ...
                            <span
                                class="text-xs font-bold tracking-wide uppercase opacity-80 text-blue-600 dark:text-blue-400">
        ...
        <div
            ...
            <!-- Left Actions Group -->
            <div v-show="!isRecording && !recordedAudio" class="flex items-center gap-1 mb-1 ml-1">
                <!-- Attachment Button -->
                <label
                    ...
                    <svg class="w-6 h-6 text-gray-500 dark:text-gray-400 group-hover:text-blue-500 dark:group-hover:text-blue-400 group-hover:scale-110 transition-transform duration-200"
                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div v-show="!isRecording && !recordedAudio" class="flex-1 py-3 min-w-0">
                <textarea ref="textareaRef" v-model="inputText" @keydown.enter.exact.prevent="sendMessage"
                    placeholder="Message..." rows="1" style="min-height: 24px;"
            ...
            <div class="relative mb-1 mr-1">
                <transition mode="out-in" enter-active-class="transition duration-300 cubic-bezier(0.34, 1.56, 0.64, 1)"
                    ...
                    leave-from-class="opacity-100 scale-100 rotate-0" leave-to-class="opacity-0 scale-50 -rotate-90">
                    ...
                    <button v-if="canSend && !isRecording && !recordedAudio" @click="sendMessage" key="send-text"
                        ...
                        <svg class="w-5 h-5 ml-0.5 -mt-0.5 rotate-90" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5"
