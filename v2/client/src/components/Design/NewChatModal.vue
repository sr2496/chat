                ...
                <div class="px-6 py-4 flex-shrink-0 border-b border-gray-200 dark:border-gray-700">
                    <div class="relative">
                        ...
                        <input v-model="userSearchQuery" type="text" placeholder="Search people..."
                            class="w-full pl-10 pr-4 py-2.5 rounded-xl bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white dark:focus:bg-gray-600 transition-colors shadow-inner text-base"
                            autofocus />
                    </div>
                </div>
